...
public class MedicoDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        adicionarMedicoPanel.setBackground(new java.awt.Color(155, 155, 155));
        adicionarMedicoPanel.setForeground(new java.awt.Color(155, 155, 155));
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Detalhes do(a) Médico(a)", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Bauhaus 93", 2, 14))); // NOI18N
        jPanel1.setForeground(new java.awt.Color(155, 155, 155));
        jPanel1.setToolTipText("");
        jPanel1.setLayout(null);

        textCrm.setBackground(new java.awt.Color(248, 248, 248));
        jPanel1.add(textCrm);
        textCrm.setBounds(160, 55, 110, 22);

        textNomeMedico.setBackground(new java.awt.Color(248, 248, 248));
        jPanel1.add(textNomeMedico);
        textNomeMedico.setBounds(290, 55, 430, 22);

        textCodigo.setEditable(false);
        textCodigo.setBackground(new java.awt.Color(248, 248, 248));
        jPanel1.add(textCodigo);
        textCodigo.setBounds(40, 55, 100, 22);

        textTelefone.setBackground(new java.awt.Color(248, 248, 248));
        jPanel1.add(textTelefone);
        textTelefone.setBounds(40, 120, 100, 22);

        textEmail.setBackground(new java.awt.Color(248, 248, 248));
        jPanel1.add(textEmail);
        textEmail.setBounds(160, 120, 390, 22);

        listEspecialidadeMedico.setBackground(new java.awt.Color(248, 248, 248));
        ...
        listEspecialidade.setBackground(new java.awt.Color(248, 248, 248));
        ...
        buttonRemoverEspecialidade.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/senai/sp/jandira/imagens/setas-para-a-esquerda.png"))); // NOI18N
        ...
        buttonAdicionarEspecialidade.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/senai/sp/jandira/imagens/seta-desenhada-para-a-direita.png"))); // NOI18N
        ...
        buttonCancelar1.setBackground(new java.awt.Color(248, 248, 248));
        ...
        buttonCancelar1.setBounds(610, 270, 90, 60);

        buttonSalvar1.setBackground(new java.awt.Color(248, 248, 248));
        ...
        buttonSalvar1.setBounds(610, 200, 90, 60);
        ...
        textDataNascimento.setBackground(new java.awt.Color(248, 248, 248));
        ...
        jPanel1.setBounds(0, 100, 760, 500);
...
//        medico.setEspecialidades();
    ...
    private void atualizarListasEspecialidades() {
        ...
        if (tipoOperacao == TipoOperacao.ADICIONAR) {
            ...
            especialidadesMedico = medico.getListaDeEspecialidadesDoMedico();
            especialidadesMedicoModel.clear();
            especialidadesMedicoModel.addAll(especialidadesMedico);
            listEspecialidadeMedico.setModel(especialidadesMedicoModel);
